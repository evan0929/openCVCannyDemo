...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void checkCurrentState() {
        ...
        int targetState;
        Log.d(TAG, "call checkCurrentState"+"mEnabled:"+mEnabled+"mCameraPermissionGranted:"
                +mCameraPermissionGranted+"mSurfaceExist:"+mSurfaceExist+"getVisibility() == VISIBLE):"+(getVisibility() == VISIBLE));
        ...
        Log.d(TAG, "call checkCurrentState"+"targetState:"+targetState+"mState:"+mState);
